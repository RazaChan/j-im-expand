...
import org.jim.server.demo.command.handler.CardListReqHandler;
...
public class ImServerDemoStart {
	...
	public static void main(String[] args)throws Exception{
		...
		//自定义cmd
		Command.addAndGet(CommandExtra.COMMAND_GET_CARDLIST_REQ.getCmdName(),CommandExtra.COMMAND_GET_CARDLIST_REQ.getCmd());
		Command.addAndGet(CommandExtra.COMMAND_GET_CARDLIST_RESP.getCmdName(),CommandExtra.COMMAND_GET_CARDLIST_RESP.getCmd());
		CommandManager.registerCommand(new CardListReqHandler());
